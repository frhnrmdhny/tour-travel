    ...
    <div>
      <div className="">
        ...
        <div className="navbar">
          <div className="navbar-start">
            <h1
              className="text-2xl font-bold italic p-1"
              style={{
          ...
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1">
              <li>
                <a className="text-white">Daftar Harga</a>
              </li>
              <li>
                <a className="text-white">Kontak Kami</a>
              </li>
              <li>
          ...
          <div className="card-body">
            ...
            <div className="inline-flex gap-96">
              <h2 className="text-white text-3xl font-bold text-balance">
                Temukan Layanan Berkualitas Tinggi dan Pengalaman Berkesan
                Bersama Kami!
              </h2>
              ...
              <div className="card w-96 border border-cyan-500 text-primary-content ">
                <div className="card-body ">
                  ...
                  <p className="text-gray-400 text-sm font-normal">
                    ...
                    mendapatkan akomodasi yang nyaman dan mewah, transportasi
                    yang aman dan nyaman, serta panduan langsung oleh pendamping
                    yang berpengalaman.
                  </p>
                </div>
              </div>
              <div className="card w-96 border border-gray-500 text-primary-content ">
                <div className="card-body ">
                  ...
                  <p className="text-gray-400 text-sm font-normal">
                    ...
                    selama perjalanan haji dan umrah. Para jamaah akan
                    didampingi oleh tim yang terlatih dan berpengalaman dalam
                    menangani kebutuhan ibadah serta logistik perjalanan.
                  </p>
                </div>
              </div>
              <div className="card w-96 border border-gray-500 text-primary-content">
                <div className="card-body">
                  ...
                  <p className="text-gray-400 text-sm font-normal">
                    Layanan ini menekankan manajemen perjalanan yang
                    terorganisir dengan baik demi kepentingan kesejahteraan dan
                    kepuasan jamaah. Semua aspek perjalanan, mulai dari
                    akomodasi, transportasi, hingga kebutuhan harian.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="p-20">
        <div className="mb-10 flex-col justify-center items-start gap-1 flex">
          ...
          <p className="text-gray-400 text-lg font-normal leading-7">
            ...
            perjalanan, menginspirasi dan melayani Anda dengan penuh dedikasi
            dan integritas.
          </p>
        </div>
            ...
            <div className="hero-content flex-col lg:flex-row">
              <div>
                ...
                <p className="py-6 text-wrap">
                  ...
                  hingga perjalanan religius seperti haji dan umrah. Tour &
                  travel berperan penting dalam membantu pelanggan merencanakan
                  dan menjalani pengalaman perjalanan yang menyenangkan, aman,
                  dan berkesan.
                </p>
              </div>
            </div>
      ...
      <div className="p-20 ">
        <div className="hero-overlay bg-white justify-between ">
          <div className="hero-content flex-col lg:flex-row-reverse ">
            ...
            />
            <div>
              <p className="text-[#01B9DE] font-bold text-md">
                Bagaimana Caranya
              </p>
              <h1 className="text-5xl font-bold w-[614px]">
                Langkah-langkah untuk mendaftar di Platform Kami.
              </h1>
              <p className="w-[614px]">
                Lorem ipsum dolor sit amet consectetur. Eu id in tortor
                elementum eget. Eget lorem egestas quis sed turpis. Luctus
                lectus augue senectus tincidunt. Vulputate cursus in ullamcorper
                purus ligula..
              </p>
              <div className="grid grid-flow-row-dense grid-cols-1 grid-rows-1 gap-[20px]">
                ...
                <div className="card text-primary-content w-[614px] ">
                  <div className="card-body">
                    ...
                    <p className="text-[#667085] text-lg text-balance">
                      Calon jamaah menyelesaikan administrasi dan persiapan
                      lainnya sesuai petunjuk agen perjalanan.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="p-20">
        ...
        <div className="flex flex-row gap-2 justify-center">
          <button className="flex-initial w-36 btn bg-gradient-to-b from-[#01B9DE] to-[#0190AD] text-white btn-ghost text-white rounded-full font-semibold">
            Semua Layanan
          </button>
        ...
        <div className="flex flex-wrap gap-[30px] justify-center items-center mt-[40px]">
          <div className="card w-72 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              ...
              <div
                tabIndex={0}
                className="collapse collapse-arrow bg-[#01B9DE]"
              >
              ...
              <button className="btn text-black font-medium text-md rounded-full bg-white outline outline-gray-200 mt-4">
                Pilih Paket
              </button>
            </div>
          </div>
          ...
          <div className="card w-72 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              <div className="badge bg-gradient-to-b from-[#01B9DE] to-[#0190AD] text-white text-white font-medium w-20 h-10">
                Haji
              </div>
        ...
        <div className="hero min-h-screen">
          <div className="hero-content flex-col lg:flex-row">
            ...
            <div>
              ...
              <p className="text-gray-400 text-balance w-[608px]">
                Menggali lebih dalam tentang keunggulan layanan Trijaya Trans
                Indo Mandiri dalam memenuhi kebutuhan transportasi Anda.
              </p>
              <div className="mt-3">
                <div className="grid grid-flow-row-dense grid-cols-1 grid-rows-1 gap-2">
                  <div className="card bg-[#F2F4F7] text-primary-content w-[608px] ">
                    <div className="card-body">
                      ...
                      <p className="text-[#667085] text-lg">
                        ...
                        dalam menyelenggarakan perjalanan haji dan umrah,
                        memberikan keamanan dan keyakinan kepada pelanggan.
                      </p>
                    </div>
                  </div>
                  <div className="card text-primary-content w-[608px] ">
                    <div className="card-body">
                      ...
                      <p className="text-[#667085] text-lg">
                        Kami menyediakan pelayanan yang disesuaikan dengan
                        kebutuhan dan preferensi individu setiap pelanggan,
                        memastikan pengalaman perjalanan yang sesuai dengan
                        harapan mereka.
                      </p>
                    </div>
                  </div>
                  <div className="card text-primary-content w-[608px] ">
                    <div className="card-body">
                      ...
                      <p className="text-[#667085] text-lg">
                        Melalui platform digital kami yang mudah diakses,
                        pelanggan dapat dengan cepat mengakses informasi,
                        melakukan pendaftaran, dan berkomunikasi dengan kami,
                        menjadikan proses pemesanan lebih lancar dan efisien..
                      </p>
                    </div>
                  </div>
                  <div className="card text-primary-content w-[608px] ">
                    <div className="card-body">
                      ...
                      <p className="text-[#667085] text-lg">
                        ...
                        siap memberikan panduan yang terampil sepanjang
                        perjalanan, memberikan dukungan penuh kepada pelanggan
                        dalam setiap tahap perjalanan mereka.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="hero-content flex-col lg:flex-row">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button className="flex-initial w-36 btn bg-gradient-to-b from-[#01B9DE] to-[#0190AD] text-white btn-ghost rounded-full font-semibold mt-8">
                  PIlih Paket
                </button>
                <button className="flex-initial w-36 btn text-[#01B9DE] rounded-full btn-ghost mt-8">
                  Hubungi Kami
                </button>
              </div>
            </div>
              ...
              <div className="card w-96 bg-white shadow-sm">
                <div className="card-body">
                  <p className="px-2 py-2">
                    ...
                    menyediakan akomodasi yang nyaman dan fasilitas yang
                    memadai, tetapi juga memberikan panduan yang sangat membantu
                    sepanjang perjalanan. Saya sangat terkesan dengan
                    profesionalisme dan keramahan tim mereka. Terima kasih atas
        ...
        <div className="grid grid-rows-4 grid-flow-col gap-4">
          ...
          >
            <div className="collapse-title text-xl font-medium text-[#01B9DE] text-lg font-bold">
              Apa yang dibutuhkan untuk mendaftar sebagai jamaah haji atau
              umrah?
            </div>
          ...
          <div tabIndex={0} className="collapse collapse-arrow">
            <div className="collapse-title text-xl font-medium">
              Bagaimana dengan prosedur keamanan dan kesehatan selama
              perjalanan?
            </div>
            <div className="collapse-content">
              <p></p>
      ...
      >
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="">
            <h1 className="mb-2 text-4xl font-bold leading-[60px] text-center text-white ">
              Tunggu Apalagi, Ayo Pilih Paket Kami Sekarang!
            </h1>
            <button className="flex-initial w-36 btn bg-gradient-to-b from-[#01B9DE] to-[#0190AD] text-white btn-ghost rounded-full font-semibold mt-8">
              PIlih Paket
            </button>
            <button className="flex-initial w-36 btn text-white rounded-full btn-ghost mt-8">
              Hubungi Kami
            </button>
          </div>
        </div>
        ...
        <footer className="footer p-10 text-base-content bg-[#003B47] rounded-xl">
          <div className="mt-2">
            ...
            <p className="text-white">
              Jl. Lokomotif Kav.pjka No.28-30 RT.007 RW.014 Padasuka, Cimahi
              Tengah
            </p>
          ...
          <nav>
            ...
            <a className="text-md font-bold text-white">
              Melangkah Bersama Menuju Puncak Kesucian
            </a>
            <a className="text-md font-normal text-white">
              Menyemai Makna dalam Setiap Langkah Perjalanan Anda
            </a>
          </nav>
        </footer>
      </div>
