...
export default function AccessHistory() {
  ...
  const [paginationModel, setPaginationModel] =
    usePagination<Prisma.LogHistoryWhereInput>()
  ...
  return (
    <Layout>
      <div className="mb-2">
        <h1 className="font-bold text-gray-800">Access History</h1>
        <h3 className="text-sm text-slate-500">Daftar data log akses</h3>
      </div>
